    ...
    return(
        <div className="w-full h-screen justify-self-center mt-32 flex justify-center md:items-center items-start md:mt-0 shadow-md rounded-md">
            <div className="flex-row md:w-[80%] w-[95%]">
                ...
                <input className="w-full mb-5 h-10 rounded-md border" 
                        required 
                        placeholder="Title. . ." 
                        type="text" 
                ...
                <input className="w-full mb-5 h-10 rounded-md border" 
                       ...
                       />
                <textarea className="w-full mb-5 h-32 max-h-92 rounded-md border" 
                          onChange={(e) => setContent(e.target.value)} 
                          placeholder="Enter your content. . ." 
                          />
                <button 
                        className="w-full h-12 btn btn-active btn-neutral bg-primary text-neutral hover:text-white btn-sm" 
                        onClick={createPost}>
                        Submit
                </button>
            </div>
